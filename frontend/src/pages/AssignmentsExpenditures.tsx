...
import { Assignment, Expenditure, Base, AssetType } from "../types/index";
import AssignmentExpenditureForm from "../components/AssignmentExpenditureForm";

const AssignmentsExpenditures = () => {
  const [activeTab, setActiveTab] = useState<"assignments" | "expenditures">(
    "assignments"
  );
  ...
  const loadData = async () => {
    ...
    try {
      ...
      const [assignRes, expendRes] = await Promise.all([
        ...
        api.get<Expenditure[]>("/expenditures/", { params }),
      ]);
  ...
  const assignmentColumns: GridColDef[] = [
    ...
    { field: "personnel_name", headerName: "Personnel", width: 150 },
  ...
  const expenditureColumns: GridColDef[] = [
    { field: "id", headerName: "ID", width: 70 },
    { field: "base_name", headerName: "Base", width: 150 },
    { field: "asset_type_name", headerName: "Asset Type", width: 150 },
    { field: "quantity", headerName: "Quantity", width: 100 },
  ...
  return (
    <Box p={3}>
      ...
      <AssignmentExpenditureForm onSuccess={loadData} />
      ...
      >
        ...
        <Tab label="Expenditures" value="expenditures" />
      </Tabs>
